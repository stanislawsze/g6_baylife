<div class="grid grid-cols-6 gap-4 col-span-full lg:col-2">
    <div class="col-span-full sm:col-span-3">
        ...
        <input id="nightNumber" wire:model="nightNumber" type="number" placeholder="2" class="w-full rounded-md focus:ring focus:ri focus:ri dark:border-gray-700 dark:text-gray-900">
    </div>
    <div class="col-span-full sm:col-span-3">
        <label for="stockNumber" class="text-sm">Nombre de Stockade</label>
        <input id="stockNumber" wire:model="stockNumber" type="number" placeholder="2" class="w-full rounded-md focus:ring focus:ri focus:ri dark:border-gray-700 dark:text-gray-900">
    </div>
    <div class="col-span-full sm:col-span-3">
        <label for="u2rNumber" class="text-sm">Nombre d'U.2.R</label>
        <input id="u2rNumber" wire:model="u2rNumber" type="number" placeholder="2" class="w-full rounded-md focus:ring focus:ri focus:ri dark:border-gray-700 dark:text-gray-900">
    </div>
    <div class="col-span-full sm:col-span-3">
        <label for="name" class="text-sm">Nom du convoi</label>
        <input id="name" wire:model="name" type="text" placeholder="ALTA DE TES MORTS" class="w-full rounded-md focus:ring focus:ri focus:ri dark:border-gray-700 dark:text-gray-900">
    </div>
    <div class="col-span-full sm:col-span-3">
    ...
    <div class="col-span-full sm:col-span-3">
        ...
        <input id="amount" wire:model="amount" type="number" placeholder="2" class="w-full rounded-md focus:ring focus:ri focus:ri dark:border-gray-700 dark:text-gray-900">
    </div>
