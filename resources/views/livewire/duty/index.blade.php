<div>
    <div class="bg-white rounded-3xl p-5 grid grid-cols-3 gap-4">
    ...
    <div class="bg-white rounded-3xl p-5 my-4">
        <div class="grid grid-cols-3 gap-4 my-4">
            <div>
                Type de mission
                <label for="Toggle4" class="rounded-3xl inline-flex items-center p-1 cursor-pointer bg-g6-3 text-gray-800">
            ...
            <div>
                ...
                <input id="mission" wire:model="mission" type="text" placeholder="Nom de la mission" class="w-full rounded-md focus:ring focus:ri focus:ri ">
            </div>
            <div>
    ...
    <div class="my-5 bg-white rounded-3xl p-5" wire:poll.visible>
    ...
    <div class="my-5 bg-white  rounded-3xl p-5">
